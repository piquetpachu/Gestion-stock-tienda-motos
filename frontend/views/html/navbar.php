  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarContenido">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link d-flex align-items-center gap-1" href="productos.php">
            Gestión de Stock
        ...
        <li class="nav-item">
          <a class="nav-link d-flex align-items-center gap-1" href="clientes.php">
            Clientes
        ...
        <li class="nav-item">
          <a class="nav-link d-flex align-items-center gap-1" href="AdmRubros.php">
            Rubros
        ...
        <li class="nav-item">
          <a class="nav-link d-flex align-items-center gap-1" href="AdmProveedores.php">
            Proveedores
        ...
        <li class="nav-item">
          <a id="navUsuarios" class="nav-link d-flex align-items-center gap-1" href="usuarios.php" style="display:none;">
            Usuario
        ...
        <li class="nav-item">
          <a class="nav-link d-flex align-items-center gap-1" href="ventas.php">
            Ventas
