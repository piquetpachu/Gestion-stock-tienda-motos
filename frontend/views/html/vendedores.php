...
<body style="display:none;">
  ...
  <div class="container mt-5" id="vendedores-panel">
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <button class="btn btn-success" id="btnAgregarVendedor">➕ Registrar Vendedor</button>
    </div>
      ...
      <form id="formVendedor" class="modal-content" autocomplete="off">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="password" id="vend_contrasena" class="form-control" placeholder="(dejar vacío para no cambiar)" />
          </div>
