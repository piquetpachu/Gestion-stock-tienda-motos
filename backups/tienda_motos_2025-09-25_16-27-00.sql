...
CREATE TABLE `cliente` (
  ...
  UNIQUE KEY `cuil_cuit_2` (`cuil_cuit`)
...
INSERT INTO `cliente` VALUES (1,'Carlos','Gómez','88888888888','carlosgomez@mail.com','3794223344','San Martín 456','2025-06-27'),(2,'Juan','Pérez','11111111111','juan@ejemplo.com','1122334455',NULL,'2025-08-15'),(3,'María','Gómez','22222222222','maria@ejemplo.com','1155667788',NULL,'2025-08-15'),(4,'Carlos','López','55555555555','carlos@ejemplo.com','1199887766','nosejajasalu2wee','2025-08-15'),(5,'nacho',NULL,'33333333333','nacho@ejemplo.com','1212121212','mi casita','2025-08-15'),(8,'Marmota','Usuario','66666666666','nuevo@nuevo.com','232323','nosejajasalu2wee','2025-08-15'),(10,'nuevo ','usaurio','44444444444','carlosgomez@mail.com','3794223344','San Martín 456','2025-08-20'),(11,'otro','usuario','99999999999','qsyo@webon.com','1212121','tucasa','2025-08-20'),(12,'ignacio','Piquet scoffield','77777777777','ignacio@gmail.com','12345678','que te importa','2025-08-24'),(13,'asd','asd','00000000000','asdasd@gmail.com','23123213','','2025-09-11'),(25,'pepepe','pepepep','00000000001','asdasdasd@asdasd.com','asdasdas','asdasda','2025-09-11'),(26,'asdasd','adasd','asdasd','asdasdasdas@asdasdasd','dasdasdas','dasdasda','2025-09-11'),(27,'sdfsdf','sdfsdf','12121212121','asd@asd.com','','','2025-09-11');
...
INSERT INTO `producto` VALUES (1,'Casco Integral GPX','Casco de alta seguridad, negro mate.',30000.00,18000.00,-6,1,1,'2025-06-27',0,2.00,'7798765432109'),(2,'Aceite 10W40 Motul','Lubricante sintético para motos 4T.',8000.00,5200.00,3,1,2,'2025-06-27',0,6.00,'1234567890123'),(127,'asd','asd',0.00,0.00,-2,NULL,NULL,'2025-09-01',0,0.00,'9399652607431'),(137,'articulo de prueba','para comprarlo XD',1000.00,500.00,3,NULL,NULL,'2025-09-01',0,1.00,'9567087638096'),(153,'producto de prueba','probando',12.00,12.00,12,9,13,'2025-09-07',0,1.00,'1236624846383'),(155,'sin idasd','asdasdas',0.00,0.00,0,NULL,3,'2025-09-10',0,0.00,'8981539778122'),(156,'sadfgg','gadsa',3.00,0.00,0,NULL,NULL,'2025-09-11',0,0.00,'9083120751954'),(157,'hola','',0.00,0.00,0,2,NULL,'2025-09-11',0,0.00,'7202475260474'),(159,'asd probando asd','',1000.00,1000.00,99,NULL,NULL,'2025-09-16',0,0.00,'8722136728062'),(160,'asd','asd',0.01,0.00,0,NULL,NULL,'2025-09-19',0,0.00,'6136175352850');
...
CREATE TABLE `producto_precio` (
  ...
  `porcentaje_flete` decimal(5,2) DEFAULT 0.00,
  `porcentaje_ganancia` decimal(5,2) DEFAULT 0.00,
  PRIMARY KEY (`id_producto_precio`),
  KEY `id_producto` (`id_producto`),
  KEY `id_medio_pago` (`id_medio_pago`),
  CONSTRAINT `producto_precio_ibfk_1` FOREIGN KEY (`id_producto`) REFERENCES `producto` (`id_producto`),
  CONSTRAINT `producto_precio_ibfk_2` FOREIGN KEY (`id_medio_pago`) REFERENCES `medio_pago` (`id_medio_pago`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rubro` VALUES (1,'Cascos'),(2,'Aceites'),(3,'Luces'),(4,'reliquias'),(6,'asd'),(7,'asdasdasd'),(8,'nuevo'),(9,'leoooo'),(10,'nachooo'),(11,'qwe'),(12,'holii'),(13,'rubro prueba'),(14,'papa'),(15,'peke'),(16,'12');
...
INSERT INTO `usuario` VALUES (1,'Admin Principal','admin@tienda.com','admin123','admin'),(2,'Vendedor Juan','juan@tienda.com','juan123','vendedor'),(7,'caro','caro@ejemplo.com','$2y$10$/P21AX/QVCkm2LxnmSJak.96QwRg5ds9mc8F2XDwnNcTw4IIJzSDO','vendedor'),(8,'nacho','nacho@ejemplo.com','$2y$10$s43858Aui8uSmytljZS59OmxSCN/tSKWWnae9U/HjuvYhqI3Y3xV2','admin'),(37,'proba','proba@ejemplo.com','$2y$10$QIthrhtPaQhdzOGkSGNBPOue.A5D40vHExi7g8DTu8KH2Q.hqW9TO','admin'),(38,'probaven','probaven@ejemplo.com','$2y$10$4bKA88jhP7uJPQ0uBoc/f..p.ZIymySsCX2/xU3V5hDeFTezs9Aji','vendedor');
...
INSERT INTO `venta_item` VALUES (70,55,1,1,30000.00,0.00000,21.00000),(71,55,2,1,8000.00,0.00000,21.00000),(72,56,1,1,30000.00,0.00000,21.00000),(73,57,1,1,30000.00,0.00000,21.00000),(74,58,2,1,8000.00,0.00000,21.00000),(76,59,1,3,30000.00,0.00000,21.00000),(79,61,1,2,30000.00,0.00000,21.00000),(80,62,127,1,0.00,0.00000,21.00000),(82,62,2,1,8000.00,0.00000,21.00000),(83,63,2,1,8000.00,0.00000,21.00000),(84,64,127,1,0.00,0.00000,21.00000),(85,65,2,2,8000.00,10.00000,21.00000),(86,66,159,1,1000.00,0.00000,21.00000),(87,66,2,1,8000.00,0.00000,21.00000),(88,67,2,5,8000.00,0.00000,21.00000);
...
INSERT INTO `venta_medio_pago` VALUES (54,55,1,45.98,NULL,'2025-08-26'),(55,56,1,36.30,NULL,'2025-08-27'),(56,57,1,36.30,NULL,'2025-08-29'),(57,58,1,9.68,NULL,'2025-09-03'),(58,59,1,112.53,NULL,'2025-09-04'),(59,60,1,1.21,NULL,'2025-09-07'),(60,61,1,72.60,NULL,'2025-09-07'),(61,62,1,10.89,NULL,'2025-09-07'),(62,63,1,9.68,NULL,'2025-09-07'),(63,64,1,0.00,NULL,'2025-09-07'),(64,65,1,17.42,NULL,'2025-09-19'),(65,66,1,10.89,NULL,'2025-09-19'),(66,67,1,48.40,NULL,'2025-09-19');
...
-- Dump completed on 2025-09-25 11:27:00
